    ...
    <?php
      ...
      if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
          ...
          $Get_rentalID =$row["rental_id"];
          $Get_amount =$row["amount"];
          $Get_pdate =$row["payment_date"];
          echo "<tr>";
          ...
          echo "<td> <form action='updatepaymentform.php' method='POST' >";
          echo "<input type='hidden' name='Get_ID' value='" .$row["payment_id"] ."'>";
          echo "<input type='hidden' name='Get_custID' value='" .$row["customer_id"] ."'>";
          echo "<input type='hidden' name='Get_staffID' value='" .$row["staff_id"] ."'>";
          echo "<input type='hidden' name='Get_rentalID' value='" .$row["rental_id"] ."'>";
          echo "<input type='hidden' name='Get_amount' value='" .$row["amount"] ."'>";
          echo "<input type='hidden' name='Get_pdate' value='" .$row["payment_date"] ."'>";
