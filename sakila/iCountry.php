...
<body>
	...
	<div class="topbar">
		 <a href="index.php" class="active"> Exit </a>
		  <a href="country.php" > View Country Table </a>
	</div>



	<div class="InsertForm">
		<form action="iCountry.php" method="post">
			<br><br><br>
			<label for="country_id"><font color="white">Country ID</font></label>
			<input type="text" id="country_id" name="country_id" placeholder="country id..">
