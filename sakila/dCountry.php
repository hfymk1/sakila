  ...
  <div class="topbar">
   ...
   <div class="dropdown">
      ...
      <div class="dropdown-content">
                ...
                ?>
				<form method="post" >
					   <input type="checkbox" name="Check1" <?php if(isset($_POST['Check1'])) echo "checked='checked'"; ?> /><font color="white">Country ID</font><br>
					   <input type="checkbox" name="Check2" <?php if(isset($_POST['Check2'])) echo "checked='checked'"; ?> /><font color="white">Country</font><br>
    ...
    <a href="country.php" class="active"> Back </a>
  ...
  <div id="maintext">
    ...
    <?php
      ...
      if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
		  ...
		  if(isset($_POST['Check3'])){
			...
			$Get_ID =$row["country_id"];
			echo "<td> <form method='POST' ><input type='hidden' name='Get_ID' value='" .$row["country_id"] ."'><input type='submit' name='delete' value='Delete'> </form> </td>";
          echo "</tr>";
        }
        echo "</table>";
      }
	  ...
	  if (isset($_POST["delete"])){
          $sql = "DELETE FROM country WHERE country_id =" . $_POST["Get_ID"];


        if ($conn->query($sql) === TRUE) {
          echo'<script type ="text/javascript">';
          echo 'alert("Record deleted successfully.");';
          echo 'window.location="dCountry.php";';
          echo '</script>';
          mysqli_close($conn);
          exit;
      } else {
