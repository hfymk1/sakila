  ...
  <div id="maintext">
    ...
    if ($result->num_rows > 0) {
      ...
      while($row = $result->fetch_assoc()) {
        ...
        echo "<td> <form action='updatestoreform.php' method='POST' >";
        echo "<input type='hidden' name='Get_ID' value='" .$row["store_id"] ."'>";
        echo "<input type='hidden' name='Get_msID' value='" .$row["manager_staff_id"] ."'>";
