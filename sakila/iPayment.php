...
<body>
	...
	<div class="topbar">
		 <a href="index.php" class="active"> Exit </a>
		  <a href="payment.php" > View Payment Table </a>
	</div>



	<div class="InsertForm">
		<form action="iPayment.php" method="post">
			<br><br><br>
			<label for="payment_id"><font color="white">Payment ID</font></label>
			<input type="text" id="payment_id" name="payment_id" placeholder="payment id..">
			...
			<label for="payment_date"><font color="white">Payment Date</font></label><br>
			<input type="datetime-local" id="payment_date" name="payment_date" <br><br><br>
