...
<body>
	...
	<div class="topbar">
		 <a href="index.php" class="active"> Exit </a>
		  <a href="actor.php" > View Actor Table </a>
	</div>



	<div class="InsertForm">
		<form action="iActor.php" method="post">
			<br><br><br>
			<label for="actor_id"><font color="white">Actor ID</font></label>
			<input type="text" id="actor_id" name="actor_id" placeholder="actor ID..">
	...
	$actor_id = mysqli_real_escape_string($link, $_REQUEST['actor_id']);
	$fname = mysqli_real_escape_string($link, $_REQUEST['fname']);
	$lname = mysqli_real_escape_string($link, $_REQUEST['lname']);

	// Attempt insert query execution
	$sql = "INSERT INTO actor (actor_id, first_name, last_name) VALUES ('$actor_id', '$fname', '$lname')";
