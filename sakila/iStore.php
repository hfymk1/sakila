...
<body>
	...
	<div class="topbar">
		 <a href="index.php" class="active"> Exit </a>
		  <a href="store.php" > View Language Table </a>
	</div>
	...
	<div class="InsertForm">
		<form action="iStore.php" method="post">
			...
			<label for="staff_id"><font color="white">Manager Staff ID</font></label>
			<input type="text" id="staff_id" name="staff_id" placeholder="manager staff id..">
	...
	$store_id= mysqli_real_escape_string($link, $_REQUEST['language_id']);
