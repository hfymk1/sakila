...
<body>
  ...
  <div class="topbar">
	 ...
	 <a href="updatecustomer.php" class="active"> Back </a>
    ...
    <?php
      ...
      if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
          ...
          echo "<td> <form action='updatecustomerform.php' method='POST' >";
          echo "<input type='hidden' name='Get_ID' value='" .$row["customer_id"] ."'>";
          echo "<input type='hidden' name='Get_store' value='" .$row["store_id"] ."'>";
          ...
          echo "<input type='hidden' name='Get_cdate' value='" .$row["create_date"] ."'>";
